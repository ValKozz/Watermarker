...
class Buttons(ctk.CTkFrame):
    ...
    def init_buttons(self, parent):
        ...
        self.btn_pick_color = ctk.CTkButton(self, image= color_palette_icon, text=None, height=BUTTON_HEIGHT,
        ...
        self.btn_pan = ctk.CTkButton(self, image=pan_icon, text=None, height=BUTTON_HEIGHT, width=BUTTON_WIDTH,
                                     command=None)
        self.btn_pan.pack(side='top', pady=10)
        self.pan_tooltip = Pmw.Balloon(self)
        self.pan_tooltip.bind(self.btn_pan, 'Pan and zoom')

        self.btn_insert_text = ctk.CTkButton(self, image=text_icon, text=None, height=BUTTON_HEIGHT, width=BUTTON_WIDTH,
                                             command=parent.open_textbox)
        ...
        self.btn_size_opacity = ctk.CTkButton(self, image=switch_icon, text=None, height=BUTTON_HEIGHT,
                                              width=BUTTON_WIDTH,
                                              command=parent.open_sliders)
        ...
        self.btn_clear_layer = ctk.CTkButton(self, image=clear_layer_icon, text=None, height=BUTTON_HEIGHT,
                                             width=BUTTON_WIDTH, command=parent.painter.reset_image)
